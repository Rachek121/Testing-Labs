...
class AddDataWin(QWidget):
    ...
    def initUI(self):
        ...
        self.setGeometry(100, 100, 400, 2000)
        ...
        self.customer_label = QLabel("XXXXXXXXX:")
    ...
    def upload_editable_data(self):
        ...
        self.acceptance_date_input.setText(self.data[3])
        self.customer_input.setText(self.data[4])
