...
class Data:
    ...
    def add_order(self, **kwargs):
        ...
        try:
            ...
            sqlite_insert_query = """ INSERT INTO orders (type_of_work, description, acceptance_date, customer, executor, status) VALUES (?, ?, ?, ?, ?, ?); """

            data = (kwargs['type_of_work'], kwargs['description'], kwargs['acceptance_date'], kwargs['customer'],
                    kwargs['executor'], kwargs['status'])
